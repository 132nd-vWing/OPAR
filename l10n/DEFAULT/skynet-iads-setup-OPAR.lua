...
--redIADS:getSAMSiteByGroupName('IADS_W_SA2_1'):addPointDefence(sa15):setHARMDetectionChance(100)
...
--redIADS:getSAMSiteByGroupName('IADS_W_SA6_1'):addPointDefence(sa15):setHARMDetectionChance(100)
...
--redIADS:getSAMSiteByGroupName('IADS_E_SA2_1'):addPointDefence(sa15):setHARMDetectionChance(100)

-- SA-2 Jirah Airfield
--local sa15 = redIADS:getSAMSiteByGroupName('IADS_E_SA15_PD_2')
--redIADS:getSAMSiteByGroupName('IADS_E_SA2_2'):addPointDefence(sa15):setHARMDetectionChance(100)
--local sa15 = redIADS:getSAMSiteByGroupName('IADS_E_SA15_PD_5')
--redIADS:getSAMSiteByGroupName('IADS_E_SA2_2'):addPointDefence(sa15):setHARMDetectionChance(100)

-- SA-6 TABQA Airfield
--local sa15 = redIADS:getSAMSiteByGroupName('IADS_E_SA15_PD_3')
--redIADS:getSAMSiteByGroupName('IADS_E_SA6_1'):addPointDefence(sa15):setHARMDetectionChance(100)

-- SA-6 KUWEIRES airfield
--local sa15 = redIADS:getSAMSiteByGroupName('IADS_E_SA15_PD_4')
--redIADS:getSAMSiteByGroupName('IADS_E_SA6_2'):addPointDefence(sa15):setHARMDetectionChance(100)
